...
## Software Engineer | Frontend-Heavy Full Stack MERN Developer | React, Next.js, TypeScript | MERN Trainer | Building Scalable Products
...
Software Engineer with 4+ years of experience, specializing in frontend-focused MERN stack development. I build scalable, high-performance web applications using React.js and Next.js, with experience in SaaS, real-time, and Web3 products. I also work as a MERN Stack Trainer and currently exploring AI integrations.

Core Technical: React.js, Next.js, Node.js, Express, MongoDB, GraphQL, Redux, WebSockets, TypeScript/JavaScript
DevOps & Tools: AWS Amplify & EC2, Netlify, Vercel, Git, Postman, Firebase
Web3: Ethereum, Solana, Wallet integrations, Smart contract integrations
UI/UX: Tailwind CSS, MUI, Bootstrap, Figma, Adobe PhotoShop, Adobe Xd
Soft Skills: Leadership, Communication, Mentorship
Other Tools: Github Copilot, Cursor AI, Trello, Jira, Clickup, Notion, MS Office
